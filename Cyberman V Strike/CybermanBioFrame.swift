...
class CybermanWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (CybermanWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (CybermanWebStatus) -> Void) {
