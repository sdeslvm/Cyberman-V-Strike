...
enum CybermanWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: CybermanWebStatus) -> Bool {
        switch (self, other) {
...
extension CybermanWebStatus {
    static func == (lhs: CybermanWebStatus, rhs: CybermanWebStatus) -> Bool {
