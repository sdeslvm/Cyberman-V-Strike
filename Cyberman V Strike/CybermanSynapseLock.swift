...
final class CybermanBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: CybermanWebLoader
    private let coordinator: CybermanWebCoordinator
    ...
    init(
        ...
        loader: CybermanWebLoader,
        coordinator: CybermanWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        CybermanOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        CybermanOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        CybermanOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension CybermanBaseWebViewController {
